...
title: OSS Scoring Matrix
description: Scoring rubric used by Repo Audit.
---
...
| **Doc information architecture (Diataxis)** | Unstructured docs in README only | Some separation (e.g. a docs folder) | Clear Diataxis structure: tutorials, how-to, reference, explanation |
